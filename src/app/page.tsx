          ...
          <form className="sm:px-12  md:px-40 py-4" onSubmit={handleSubmit}>
            <label className="flex flex-col min-w-40 h-12 w-full">
              <div className="flex w-full flex-1 items-stretch rounded-xl h-full">
                <div
                  className="text-[#6a7981] flex border-none bg-[#f1f3f4] items-center justify-center pl-4 rounded-l-xl border-r-0"
                ...
                <input
                  ...
                  className="form-input flex w-full min-w-0 flex-1 resize-none overflow-hidden rounded-xl text-[#121516] focus:outline-0 focus:ring-0 border-none bg-[#F1F3F4] focus:border-none h-full placeholder:text-[#6a7981] px-4 rounded-l-none border-l-0 pl-2 text-base font-normal leading-normal"
